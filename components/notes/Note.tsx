        ...
        {note ? (
          <div className="w-full">
            <div className="flex flex-col items-center border-b border-solid">
              <div className="w-full">
                <div className="h-20 flex justify-between portrait:flex-col-reverse portrait:h-auto">
                  ...
                  <h1 className="text-3xl my-2 font-bold portrait:self-center">{note?.title}</h1>
